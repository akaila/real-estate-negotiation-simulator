...
def configure_openai_compat_env(base_url: str | None = None, api_key: str | None = None) -> str:
...
def resolve_model_id(default_model: str = DEFAULT_MODEL, include_agent_model: bool = False) -> str:
    ...
    candidates.extend([os.environ.get("ADK_MODEL"), os.environ.get("LMSTUDIO_MODEL"), default_model])
...
def setup_lmstudio_model(default_model: str = DEFAULT_MODEL, include_agent_model: bool = False) -> str:
